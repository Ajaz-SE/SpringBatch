...
public class BatchConfig {
	...
	private LineMapper<User> getLineMapper() {
		...
		LineTokenizer.setNames(new String[] {"Id","FirstName","LastName","Subject","Result"});
	...
	public JdbcBatchItemWriter<User> writer(){
		...
		writer.setSql("insert into user(id,firstName,lastName,subject,result) values(:id,:firstName,:lastName,:subject,:result)");
